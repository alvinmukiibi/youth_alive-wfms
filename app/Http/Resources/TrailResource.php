...
class TrailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'accountant' => User::find($this->accountant_id)->fname . ' ' . User::find($this->accountant_id)->lname,
            ...
            'level_one_approver' => $this->level_one_approver_id ? User::find($this->level_one_approver_id)->fname . ' ' . User::find($this->level_one_approver_id)->lname : null,
            ...
            'level_two_approver' => $this->level_two_approver_id ? User::find($this->level_two_approver_id)->fname . ' ' . User::find($this->level_two_approver_id)->lname : null,
            ...
            'level_three_approver' => $this->level_three_approver_id ? User::find($this->level_three_approver_id)->fname . ' ' . User::find($this->level_three_approver_id)->lname : null,
