                            ...
                            <table class="table table-striped table-bordered table-hover" >
                                ...
                                <tbody>
                                    <tr v-for="type in designations" :key="type.id">
                                        <td >{{ type.name }}</td>
                                        <td>
                                            <button @click="deleteDesi(type.id)" class="btn btn-sm btn-outline-danger"><i class="fa fa-trash"></i></button>
                                            <button @click="setDesi(type.id)" type="button" data-toggle="modal" data-target="#modal" class="btn btn-sm btn-outline-primary"><i class="fa fa-pencil"></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
export default {
    ...
    methods: {
        ...
        saveEdit(){
            ...
            axios.post(this.prefix + `/designations/update/${this.designation.id}`, {name: this.designation.name})
            .then(response => {
        ...
        deleteDesi(id){
            axios.get(this.prefix + `/designations/delete/${id}`)
            .then(response => {
                this.loadDesignations()
            });
        },
