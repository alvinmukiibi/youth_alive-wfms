                                ...
                                <ul class="nav nav-pills">
                                    <li class="nav-item">
                                        <a
                                            ...
                                            data-toggle="tab"
                                        >
                                            <i class="fa fa-list-alt"></i> My
                                            Leaves
                                        </a>
                                    </li>
                                    <li
                                        v-if="auth.user_type == 'manager'"
                                        class="nav-item"
                                    >
                                        <a
                        ...
                        Ask for leave
                                            ...
                                            <small class="text-danger">
                                                <i
                                                    ...
                                                    submit the leave form 1 week
                                                    prior to the first day you
                                                    will be absent**</i
                                                >
                                            </small>
                                        </div>
