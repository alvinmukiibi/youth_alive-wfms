                ...
                <ul class="nav nav-pills">
                  <li class="nav-item">
                    <a class="nav-link active" href="#requests" data-toggle="tab">
                      <i class="fa fa-list-alt"></i> Requests
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#make" data-toggle="tab">
                      <i class="fa fa-plus-circle"></i> Make Request
                    </a>
                  </li>
                </ul>
              </div>
              <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="card card-primary card-outline">
                      <div class="card-header">
                        <ul class="nav nav-pills">
                          ...
                          <li
                            @click="loadProjectRequests"
                            v-if="auth.is_accountant"
                            class="nav-item"
                          >
                            <a class="nav-link" href="#projectrequests" data-toggle="tab">
                              Project Requests
                              <span
                                v-if="spin2"
                                class="spinner-border spinner-border-sm"
                          ...
                          <li
                            @click="loadLevel1Requests"
                            v-if="stateLoaded && auth.roles.includes('manager')"
                            class="nav-item"
                          >
                            <a class="nav-link" href="#level1requests" data-toggle="tab">
                              Supervisor Requests
                              <span
                                v-if="spin3"
                                class="spinner-border spinner-border-sm"
                          ...
                          <li
                            @click="loadFMRequests"
                            v-if="stateLoaded && auth.roles.includes('manager') && auth.department == 'Finance and Operations'"
                            class="nav-item"
                          >
                            <a class="nav-link" href="#fmrequests" data-toggle="tab">
                          ...
                          <li
                            @click="loadDirectorRequests"
                            v-if="stateLoaded && auth.roles.includes('director')"
                            class="nav-item"
                          >
                            <a class="nav-link" href="#directorrequests" data-toggle="tab">
                          ...
                          <li
                            @click="loadEDRequests"
                            v-if="stateLoaded && auth.designation == 'Executive Director'"
                            class="nav-item"
                          >
                            <a class="nav-link" href="#edrequests" data-toggle="tab">
                              Pending ED Approval
                              <span
                                v-if="spin6"
                                class="spinner-border spinner-border-sm"
                            ...
                            <b-table-simple small caption-top responsive>
                              ...
                              <b-tbody>
                                <b-tr v-for="req in myRequests" :key="req.id">
                                  <b-td>
                                    <router-link to="/request/make">
                                      <span @click="loadRequest(req.id)">
                                        <b>{{ req.identity }}</b>
                                      </span>
                                    </router-link>
                                  </b-td>
                                  ...
                                  <b-td
                                    v-if="req.trail.accountant_approval == 0 && req.status != 2"
                                  >
                                    <button
                                  ...
                                  <b-td
                                    v-if="req.trail.level_three_approval == 1 || (req.trail.level_two_approval == 1 && req.requestor_type == 'director')"
                                  >
                                    <button
                                      :disabled="disabled"
                              ...
                              <b-tbody>
                                <b-tr v-for="req in bucket" :key="req.id">
                                  ...
                                  <b-td v-if="req.trail.accountant_approval == 0">
                                    ...
                                    <button
                                      @click="sendDecToken(req.id, 'proj')"
                              ...
                              <b-tbody>
                                <b-tr v-for="req in bucket" :key="req.id">
                                  ...
                                  <b-td v-if="req.trail.level_one_approval == 0">
                                    ...
                                    <button
                                      @click="sendDecToken(req.id, 'lev1')"
                                      class="btn btn-outline-danger btn-sm"
                                    >
                                      Decline
                                      <span
                            ...
                            <b-table-simple small caption-top responsive>
                              ...
                              <b-tbody>
                                <b-tr v-for="req in bucket" :key="req.id">
                                  ...
                                  <b-td>{{ req.project }}</b-td>
                                  <b-td
                                    v-if="req.requestor_type == 'officer' && req.trail.finance_approval == 0"
                                  >
                                    <button
                                      @click="sendToken(req.id, 'finm')"
                                      type="button"
                                      class="btn btn-outline-success btn-sm"
                                    >
                                      Approve
                                    ...
                                    <button
                                      @click="sendDecToken(req.id, 'finm')"
                                      class="btn btn-outline-danger btn-sm"
                                    >
                                      Decline
                                      <span
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'officer' && req.trail.finance_approval == 1"
                                  >
                                    <button class="btn btn-success btn-sm btn-flat">
                                      <i class="fa fa-check"></i> Approved
                                    </button>
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'officer' && req.trail.finance_approval == 2"
                                  >
                                    <button class="btn btn-danger btn-sm btn-flat">
                                      <i class="fa fa-times"></i> Declined
                                    </button>
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'manager' && req.trail.level_two_approval == 0"
                                  >
                                    <button
                                      @click="sendToken(req.id, 'finm')"
                                      type="button"
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'manager' && req.trail.level_two_approval == 1"
                                  >
                                    <button class="btn btn-success btn-sm btn-flat">
                                      <i class="fa fa-check"></i> Approved
                                    </button>
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'manager' && req.trail.level_two_approval == 2"
                                  >
                                    <button class="btn btn-danger btn-sm btn-flat">
                                      <i class="fa fa-times"></i> Declined
                                    </button>
                            ...
                            <b-table-simple small caption-top responsive>
                              ...
                              <b-tbody>
                                <b-tr v-for="req in bucket" :key="req.id">
                                  ...
                                  <b-td>{{ req.project }}</b-td>
                                  <b-td
                                    v-if="req.requestor_type == 'officer' && req.trail.level_two_approval == 0"
                                  >
                                    <button
                                      @click="sendToken(req.id, 'lev2')"
                                      type="button"
                                      class="btn btn-outline-success btn-sm"
                                    >
                                      Approve
                                    ...
                                    <button
                                      @click="sendDecToken(req.id, 'lev2')"
                                      class="btn btn-outline-danger btn-sm"
                                    >
                                      Decline
                                      <span
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'officer' && req.trail.level_two_approval == 1"
                                  >
                                    <button class="btn btn-success btn-sm btn-flat">
                                      <i class="fa fa-check"></i> Approved
                                    </button>
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'officer' && req.trail.level_two_approval == 2"
                                  >
                                    <button class="btn btn-danger btn-sm btn-flat">
                                      <i class="fa fa-times"></i> Declined
                                    </button>
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'manager' && req.trail.level_one_approval == 0"
                                  >
                                    <button
                                      @click="sendToken(req.id, 'lev2')"
                                      type="button"
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'manager' && req.trail.level_one_approval == 1"
                                  >
                                    <button class="btn btn-success btn-sm btn-flat">
                                      <i class="fa fa-check"></i> Approved
                                    </button>
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'manager' && req.trail.level_one_approval == 2"
                                  >
                                    <button class="btn btn-danger btn-sm btn-flat">
                                      <i class="fa fa-times"></i> Declined
                                    </button>
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'director' && req.trail.level_one_approval == 0"
                                  >
                                    <button
                                      @click="sendToken(req.id, 'lev1')"
                                      type="button"
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'director' && req.trail.level_one_approval == 1"
                                  >
                                    <button class="btn btn-success btn-sm btn-flat">
                                      <i class="fa fa-check"></i> Approved
                                    </button>
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'director' && req.trail.level_one_approval == 2"
                                  >
                                    <button class="btn btn-danger btn-sm btn-flat">
                                      <i class="fa fa-times"></i> Declined
                                    </button>
                            ...
                            <b-table-simple small caption-top responsive>
                              ...
                              <b-tbody>
                                <b-tr v-for="req in bucket" :key="req.id">
                                  ...
                                  <b-td>{{ req.project }}</b-td>
                                  <b-td
                                    v-if="req.requestor_type != 'director' && req.trail.level_three_approval == 0"
                                  >
                                    <button
                                      @click="sendToken(req.id, 'lev3')"
                                      type="button"
                                      class="btn btn-outline-success btn-sm"
                                    >
                                      Approve
                                    ...
                                    <button
                                      @click="sendDecToken(req.id, 'lev3')"
                                      class="btn btn-outline-danger btn-sm"
                                    >
                                      Decline
                                      <span
                                  ...
                                  <b-td
                                    v-if="req.requestor_type != 'director' && req.trail.level_three_approval == 1"
                                  >
                                    <button class="btn btn-success btn-sm btn-flat">
                                      <i class="fa fa-check"></i> Approved
                                    </button>
                                  ...
                                  <b-td
                                    v-if="req.requestor_type != 'director' && req.trail.level_three_approval == 2"
                                  >
                                    <button class="btn btn-danger btn-sm btn-flat">
                                      <i class="fa fa-times"></i> Declined
                                    </button>
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'director' && req.trail.level_two_approval == 0"
                                  >
                                    <button
                                      @click="sendToken(req.id, 'lev3')"
                                      type="button"
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'director' && req.trail.level_two_approval == 1"
                                  >
                                    <button class="btn btn-success btn-sm btn-flat">
                                      <i class="fa fa-check"></i> Approved
                                    </button>
                                  ...
                                  <b-td
                                    v-if="req.requestor_type == 'director' && req.trail.level_two_approval == 2"
                                  >
                                    <button class="btn btn-danger btn-sm btn-flat">
                                      <i class="fa fa-times"></i> Declined
                                    </button>
                          ...
                          <div class="card card-outline card-success">
                            <div class="card-body">
                              <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                  <input
                                    v-model="approvalBag.token"
                                    type="text"
                                    placeholder="e.g. 567G"
                                    class="form-control"
                                  />
                                </div>
                              </div>
                  ...
                  <div class="tab-pane" id="make">
                    <div class="card card-primary card-outline">
                      <div class="card-header">
                        <h3 class="card-title">Please choose your request type</h3>
                      </div>
                      <div class="card-body">
                        <b-form-group>
                          <b-form-radio-group
                        ...
                        <b-form-group
                          ...
                          label="Please select the documents to fill"
                        >
    ...
    sendToken(id, ty) {
      ...
      api.sendToken(data).then(response => {
        ...
        this.showToast(
          "primary",
          "Token",
          "Token has been generated and sent, check your email and retrieve token"
        );
    ...
    save() {
      ...
      api.makeReq(data).then(response => {
        ...
        this.showToast(
          "success",
          "Notification",
          "Saved! Please fill the documents on the next page"
        );
