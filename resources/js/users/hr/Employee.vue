              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       :src="'/storage/users/' + employee.profile_picture"
                ...
                <router-link to="/employees" class="btn btn-primary btn-block btn-flat btn-outline"><b> <i class="fa fa-backward"></i> Back </b></router-link>
              </div>
            </div>
          </div>
          <div class="col-md-9">
              <div class="card card-primary card-outline">
                  <div class="card-header">
                      <h3 class="card-title">
                          Employment Details <small class="text-primary">**  To edit, please click in the field and type **</small>
                      </h3>
                  </div>
                  <div class="card-body">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-10">
                              <input type="text" v-if="!dropDown2"  @click="dropDown2 = true" :value="employee.designation" class="form-control">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-10">
                              <input type="text" v-if="!dropDown3"  @click="dropDown3 = true" :value="employee.contract" class="form-control">
