                ...
                <div class="row">
                  ...
                  <li class="list-group-item">
                    ...
                    <a class="float-right">13,287</a>
                                ...
                                <router-link
                                    to="/employees"
                                    class="btn btn-primary btn-block btn-flat btn-outline"
                                >
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">
                                    ...
                                    <small class="text-primary"
                                        >** To edit, please click in the field
                                        and type **</small
                                    >
                                </h3>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input
                                            type="text"
                                            v-if="!dropDown4"
                                            @click="dropDown4 = true"
                                            :value="employee.directorate"
                                            class="form-control"
                                        />
                                        <select
                                            v-model="user.directorate_id"
                                            v-else
                                            name
                                            id
                                            class="form-control"
                                        >
                                            <option disabled
                                                >Select Directorate</option
                                            >
                                            <option
                                                v-for="dir in directorates"
                                                :value="dir.id"
                                                :key="dir.id"
                                                >{{ dir.name }}</option
                                            >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <span
                                            v-if="employee.availability_status"
                                        >
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input
                                            type="text"
                                            v-model="employee.mobile_contact"
                                            class="form-control"
                                        />
                                    </div>
                                </div>
    ...
    methods: {
        ...
        save() {
            ...
            let data = {
                ...
                directorate_id: this.user.directorate_id,
