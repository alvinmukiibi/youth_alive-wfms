...
export function saveProfile(data) {
    return axios
        .post(prefix + "/users/save/profile", data)
        .then(response => response.data);
}
export function saveUserEdit(data, id) {
    return axios
        .post(prefix + `/users/save/edit/${id}`, data)
        .then(response => response.data);
}
...
export function activateUser(id) {
    return axios
        .get(prefix + `/users/activate/${id}`)
        .then(response => response.data);
}
export function deactivateUser(id) {
    return axios
        .get(prefix + `/users/deactivate/${id}`)
        .then(response => response.data);
}
...
export function addUser(data) {
    return axios
        .post(prefix + "/users/add", data)
        .then(response => response.data);
}
export function attachRole(data) {
    return axios
        .post(prefix + "/users/attach/role", data)
        .then(response => response.data);
}
export function detachRole(data) {
    return axios
        .post(prefix + "/users/detach/role", data)
        .then(response => response.data);
}
export function attachProject(data) {
    return axios
        .post(prefix + "/users/attach/project", data)
        .then(response => response.data);
}
export function detachProject(data) {
    return axios
        .post(prefix + "/users/detach/project", data)
        .then(response => response.data);
}
...
export function saveContract(data) {
    return axios
        .post(prefix + "/admin/contracts", data)
        .then(response => response.data);
}
export function saveDesignation(data) {
    return axios
        .post(prefix + "/designations", data)
        .then(response => response.data);
}
...
export function saveLeaveType(data) {
    return axios
        .post(prefix + "/admin/leavetypes", data)
        .then(response => response.data);
}
export function saveVendor(data) {
    return axios
        .post(prefix + "/admin/vendors", data)
        .then(response => response.data);
}
export function saveDp(data, id) {
    return axios
        .post(prefix + `/users/save/dp/${id}`, data)
        .then(response => response.data);
}
export function addRequest(data) {
    return axios
        .post(prefix + "/requests", data, {
            headers: {
...
export function saveRequest(data, id) {
    return axios
        .post(prefix + `/requests/update/${id}`, data, {
            headers: {
                "Content-Type": "multipart/form-data"
            }
        })
...
export function downloadFile(id) {
    return axios
        .get(prefix + `/download/file/${id}`)
        .then(response => response.data);
}
export function getProjectRequests() {
    return axios
        .get(prefix + "/requests/accountant")
        .then(response => response.data);
}
export function getLevel1Requests() {
    return axios
        .get(prefix + "/requests/firstlevel")
        .then(response => response.data);
}
export function getFMRequests() {
    return axios
        .get(prefix + "/requests/fmrequests")
        .then(response => response.data);
}
export function getDirectorRequests() {
    return axios
        .get(prefix + "/requests/directorreqeuests")
        .then(response => response.data);
}
export function getEDRequests() {
    return axios
        .get(prefix + "/requests/edrequests")
        .then(response => response.data);
}
export function giveAccountantApproval(req) {
    return axios
        .post(prefix + "/requests/accountant", {
            request_id: req,
...
export function giveLevel1Approval(req) {
    return axios
        .post(prefix + "/requests/firstlevel", {
            request_id: req,
...
export function givefMApproval(req) {
    return axios
        .post(prefix + "/requests/fmrequests", {
            request_id: req,
...
export function giveEDApproval(req) {
    return axios
        .post(prefix + "/requests/edrequests", {
            request_id: req,
...
export function giveDirectorApproval(req) {
    return axios
        .post(prefix + "/requests/directorreqeuests", {
            request_id: req,
...
export function cancelLeave(id) {
    return axios
        .get(prefix + `/leaves/cancel/${id}`)
        .then(response => response.data);
}
export function approveLeave(id) {
    return axios
        .get(prefix + `/leaves/approve/${id}`)
        .then(response => response.data);
}
...
export function getPendingLeaves() {
    return axios
        .get(prefix + "/leaves/pending")
        .then(response => response.data);
}
export function declineLeave(data) {
    return axios
        .post(prefix + `/leaves/decline/${data.id}`, {
            reason: data.reason
        })
        .then(response => response.data);
}
...
export function getSystemSettings() {
    return axios
        .get(prefix + "/settings/system")
        .then(response => response.data);
}
export function getLeaveStats() {
    return axios
        .get(prefix + "/reports/leaves")
        .then(response => response.data);
}
export function setHoliday(data) {
    return axios
        .post(prefix + "/leaves/holidays", data)
        .then(response => response.data);
}
...
export function saveTSoW(data) {
    return axios
        .post(prefix + "/programs/savetsow", data)
        .then(response => response.data);
}
export function saveVhr(data) {
    return axios
        .post(prefix + "/programs/savevhr", data)
        .then(response => response.data);
}
export function saveBudget(data) {
    return axios
        .post(prefix + "/programs/savebudget", data)
        .then(response => response.data);
}
export function updateRequestThatDocIsCompleted(data) {
    return axios
        .post(prefix + "/programs/changedoccompletionstatus", data)
        .then(response => response.data);
}
export function saveAttachments(data) {
    return axios
        .post(prefix + "/programs/save/attachments", data)
        .then(response => response.data);
}
export function sendToken(data) {
    return axios
        .post(prefix + "/requests/send/token", data)
        .then(response => response.data);
}
export function checkAndInvalidateToken(data) {
    return axios
        .post(prefix + "/requests/check/token", data)
        .then(response => response.data);
}
export function cancelRequest(id) {
    return axios
        .post(prefix + "/requests/cancel", {
            id: id
        })
        .then(response => response.data);
}
export function downloadAttachment(id) {
    return axios
        .get(prefix + `/requests/download/attachment/${id}`)
        .then(response => response.data);
}
export function getRequestAttachments(id) {
    return axios
        .post(prefix + "/requests/get/attachments", {
            id: id
        })
        .then(response => response.data);
}
export function getRequestNotes(id) {
    return axios
        .post(prefix + "/requests/get/notes", {
            id: id
        })
        .then(response => response.data);
}
export function saveNotes(data) {
    return axios
        .post(prefix + "/requests/save/notes", data)
        .then(response => response.data);
}
...
export function loadChat(id) {
    return axios
        .get(prefix + `/chat/single/${id}`)
        .then(response => response.data);
}
export function checkUnreadMessage() {
    return axios
        .get(prefix + "/chat/unread/count")
        .then(response => response.data);
}
export function getTimesheet(data) {
    return axios
        .post(prefix + "/timesheet", data)
        .then(response => response.data);
}
export function saveTimesheet(data) {
    return axios
        .post(prefix + "/timesheet/save", data)
        .then(response => response.data);
}
export function saveSch(data) {
    return axios
        .post(prefix + "/timesheet/save/scheduled", data)
        .then(response => response.data);
}
export function saveWorkedHours(data) {
    return axios
        .post(prefix + "/timesheet/save/worked", data)
        .then(response => response.data);
}
export function saveOvertime(data) {
    return axios
        .post(prefix + "/timesheet/save/overtime", data)
        .then(response => response.data);
}
export function loadTimesheet(data) {
    return axios
        .post(prefix + "/timesheet/staff", data)
        .then(response => response.data);
}
export function getSuboordinates() {
    return axios
        .get(prefix + "/timesheet/subs")
        .then(response => response.data);
}
